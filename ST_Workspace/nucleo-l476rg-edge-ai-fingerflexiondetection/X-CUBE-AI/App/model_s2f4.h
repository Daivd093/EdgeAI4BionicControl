/**
  ...
  ******************************************************************************
  */
#ifndef AI_MODEL_S2F4_H
#define AI_MODEL_S2F4_H

#include "model_s2f4_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODEL_S2F4_MODEL_NAME          "model_s2f4"
#define AI_MODEL_S2F4_ORIGIN_MODEL_NAME   "model_s2f4_int8"

/******************************************************************************/
#define AI_MODEL_S2F4_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_S2F4_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_S2F4_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_S2F4_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_S2F4_IN \
  ai_model_s2f4_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_S2F4_IN_SIZE { \
  AI_MODEL_S2F4_IN_1_SIZE, \
}
#define AI_MODEL_S2F4_IN_SIZE_BYTES { \
  AI_MODEL_S2F4_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_S2F4_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_S2F4_IN_1_CHANNEL     (1153)
#define AI_MODEL_S2F4_IN_1_SIZE        (1153)
#define AI_MODEL_S2F4_IN_1_SIZE_BYTES  (4612)

/******************************************************************************/
#define AI_MODEL_S2F4_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_S2F4_OUT \
  ai_model_s2f4_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_S2F4_OUT_SIZE { \
  AI_MODEL_S2F4_OUT_1_SIZE, \
}
#define AI_MODEL_S2F4_OUT_SIZE_BYTES { \
  AI_MODEL_S2F4_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_S2F4_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_S2F4_OUT_1_CHANNEL     (1)
#define AI_MODEL_S2F4_OUT_1_SIZE        (1)
#define AI_MODEL_S2F4_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODEL_S2F4_N_NODES (5)
 ...
 * @ref ai_model_s2f4_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_s2f4_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_s2f4_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_s2f4_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_S2F4_*
 * defines into file @ref model_s2f4.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_model_s2f4_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODEL_S2F4_H */
