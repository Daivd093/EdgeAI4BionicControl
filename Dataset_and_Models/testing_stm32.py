...
def main():
    ...
    try:
        ...
        predicted_stm32_noproc = loadmat(f'Predictions/subj{s}_stm32_testpredictions.mat')
    ...
    assert len(nn_dg) == len(nn_stm_dg), logging.error("Largo de etiquetas predichas en pc y en stm32 es distinto.")
